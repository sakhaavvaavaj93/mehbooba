...
from mehbooba.modules.helper_funcs.msg_types import Types
from mehbooba.modules.sql import BASE, SESSION
...
"കണ്ണിൽ കൊള്ളാൻ ഉള്ളത് പുരികത്ത് കൊണ്ട് പോയി ന്ന്  വിചാരിച്ചാൽ മതി.",
"കണ്ണ് തുറന്നു ഇങ്ങോട്ട് ഒന്ന് നോക്ക് .... നാശത്തിലേക്ക് ആണ് നീ വന്നു കയറിയത് .",
"വന്നു കണ്ടു കീഴടക്കാൻ വന്നത് ആണേൽ പുറകിൽ ആറ്റം ബോംബ് വച്ച് പൊട്ടിക്കും.....",
"കണികാണും നേരം കമലനെത്രൻ്റെ കടവായിൽ കൂടെ എലി ചാടി",
]
DEFAULT_GOODBYE_MESSAGES = [
"നീ നാശത്തിലേക്ക് ആണ് പോകുന്നത് . എന്തായാലും പോകുകയല്ലെ ഇതും കൂടെ കൊണ്ട് പൊയ്ക്കോ ... 💃🗯️",
class Welcome(BASE):
