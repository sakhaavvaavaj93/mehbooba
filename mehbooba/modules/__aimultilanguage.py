...
from mehbooba.helper_extra.aichat import add_chat, get_session, remove_chat
from mehbooba.pyrogramee.pluginshelper import admins_only, edit_or_reply
from mehbooba import pbot as evil
...
async def hmm(_, message):
    ...
    if status == "ON" or status == "on" or status == "On":
        ...
        if not lol:
            await lel.edit("@stenzle_MariaGbot AI Already Activated In This Chat")
            return
        await lel.edit(
            f"@stenzle_MariaGbot AI Successfully Added For Users In The Chat {message.chat.id}"
        )
