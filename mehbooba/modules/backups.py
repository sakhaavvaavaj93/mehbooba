...
import mehbooba.modules.sql.notes_sql as sql
from mehbooba import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from mehbooba.__main__ import DATA_IMPORT
from mehbooba.modules.helper_funcs.chat_status import user_admin
from mehbooba.modules.helper_funcs.alternate import typing_action

# from mehbooba.modules.rules import get_rules
import mehbooba.modules.sql.rules_sql as rulessql

# from mehbooba.modules.sql import warns_sql as warnssql
import mehbooba.modules.sql.blacklist_sql as blacklistsql
from mehbooba.modules.sql import disable_sql as disabledsql

# from mehbooba.modules.sql import cust_filters_sql as filtersql
# import mehbooba.modules.sql.welcome_sql as welcsql
import mehbooba.modules.sql.locks_sql as locksql
from mehbooba.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("mehbooba{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("mehbooba{}.backup".format(chat_id), "rb"),
        caption="💾*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `mehbooba-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("mehbooba{}.backup".format(chat_id))  # Cleaning file
