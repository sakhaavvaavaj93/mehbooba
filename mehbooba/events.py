...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        import importlib
        import mehbooba .events

        path = Path(f"mehbooba /modules/{shortname}.py")
        name = "mehbooba .modules.{}".format(shortname)
        ...
        mod.mehbooba  = mehbooba 
        mod.tbot = telethn
        mod.logger = logging.getLogger(shortname)
        spec.loader.exec_module(mod)
        sys.modules["mehbooba .modules." + shortname] = mod
        print("Successfully imported " + shortname)


path = "mehbooba /modules/*.py"
